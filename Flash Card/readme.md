...
Flash Card is a GUI app which is used to learn french words from translate it into english. Depends  on the Python Standard Library such as tkinter, random , pyperclip, pandas, etc
